...
case "$LINTER" in
"qodana-jvm")
    qodana_image='registry.jetbrains.team/p/sa/containers/qodana-jvm:213.4158.28' #jetbrains/qodana-jvm:2021.2-eap
    ;;
"qodana-php")
    qodana_image='registry.jetbrains.team/p/sa/containers/qodana-php:213.4144.47' #jetbrains/qodana-php:2021.2-eap
    ;;
"qodana-python")
    qodana_image='registry.jetbrains.team/p/sa/containers/qodana-python:213.4158.57' #jetbrains/qodana-python:2021.2-eap
    ;;
*)
